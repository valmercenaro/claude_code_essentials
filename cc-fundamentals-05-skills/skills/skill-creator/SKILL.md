...
Store skill creation info: `cortex_remember`
- Content: Skill name, purpose, key design decisions, bundled resources created
- Tags: ["skill-creator", "{skill_name}"]
- Type: "decision"
- Include patterns that worked well for future skill creation
